...
const OurProcess = () => {
    ...
    const Card = ({ backgroundImage, topText, bottomText, title }) => (
        <>
            <div className="card-content">
                ...
                <div className="top-text"  style={{ zIndex: 1000  , color:"#000"}}>{topText}</div>
                {/* <div className='contact'> */}
                    <h2 style={{ zIndex: 1000 , color:"#000" }}>{title}</h2>
                    <div className="bottom-text" style={{ zIndex: 1000 , color:"#76867e" }}>{bottomText}</div>
                {/* </div> */}
            </div>
        </>
    );
    ...
    return (
        <div className='Process' style={{backgroundColor:`#E7F0E9` , marginTop:'50px'}}>
