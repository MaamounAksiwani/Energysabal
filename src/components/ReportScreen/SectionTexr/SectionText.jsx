...
const SectionText = () => {
    ...
    return (
        <div style={{ backgroundColor: '#3b715a', padding: '50px 0 ', textAlign: 'center' }} >
            <Container maxWidth='lg'>
                <h1 style={{color:'#C7CCCA', fontSize:'25px', fontWeight:'500' , padding:'25px'}}>Ready to take the first step towards a greener, more sustainable
